...
| 我们没有内置      | 替代方案                                                                                              |
| ----------------- | ----------------------------------------------------------------------------------------------------- |
| **没有 MCP**      | 构建带 README 的 CLI 工具（见 Skills），或写一个扩展添加 MCP 支持。[为什么？](https://pi.dev/blog/pi) |
| **没有子代理**    | 通过 tmux 派生 Pi 实例，或用扩展构建自己的实现，或安装一个包。                                        |
| **没有权限弹窗**  | 在容器中运行，或用扩展构建符合你环境与安全需求的确认流程。                                            |
| **没有计划模式**  | 把计划写到文件里，或用扩展构建，或安装一个包。                                                        |
| **没有内置待办**  | 使用 TODO.md 文件，或用扩展构建自己的。                                                               |
